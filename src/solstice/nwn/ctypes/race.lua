...
typedef struct {
    ...
    int8_t   ra_str_adjust;    /* 0018 */
    int8_t   ra_dex_adjust;    /* 0019 */
    int8_t   ra_int_adjust;    /* 001A */
    int8_t   ra_cha_adjust;    /* 001B */
    int8_t   ra_wis_adjust;    /* 001C */
    int8_t   ra_con_adjust;    /* 001D */
